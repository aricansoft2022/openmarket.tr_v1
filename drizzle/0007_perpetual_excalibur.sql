...
CREATE TABLE "supplier_companies" (
	...
	"business_identity_review_id" uuid NOT NULL,
...
ALTER TABLE "supplier_companies" ADD CONSTRAINT "supplier_companies_business_identity_review_id_business_identity_reviews_id_fk" FOREIGN KEY ("business_identity_review_id") REFERENCES "public"."business_identity_reviews"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "supplier_companies_business_identity_review_idx" ON "supplier_companies" USING btree ("business_identity_review_id");--> statement-breakpoint
